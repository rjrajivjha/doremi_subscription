...
def process_Lines(Lines):
    ...
    for line in Lines:
        ...
        if subscription_start_date is None and command == ADD_SUBSCRIPTION:
            print(f'{ADD_SUBSCRIPTION_FAILED} {INVALID_DATE}')

        if subscription_start_date is None and command == ADD_TOP_UP:
        ...
        if command == ADD_TOP_UP and subscription_start_date and top_ups:
            print("ADD_TOPUP_FAILED DUPLICATE_TOPUP")

        if command == ADD_TOP_UP and subscription_start_date and not top_ups:
